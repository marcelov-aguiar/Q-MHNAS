...
if __name__ == "__main__":
	...
	config_files = [
		"config_files/config_air_quality_v6.txt",
		"config_files/config_air_quality_v7.txt",
		"config_files/config_air_quality_v8.txt",
		"config_files/config_air_quality_v9.txt"
	]
