...
class ConfigParameters(object):
    def __init__(self, args, phase):
        ...
        self.best_individual_info = None
    ...
    def _get_evolution_params(self):
        ...
        self.train_spec['log_file_path'] = self.args['log_file_path']
        self.train_spec['model_path'] = self.args['model_path']
    ...
    def load_evolved_data(self, experiment_path: str):
        ...
        self.best_individual_info = best_individual_info
