...
class EvalPopulation(object):
    ...
    def __call__(self, decoded_params: list, decoded_nets: list, generation: int):
        ...
        #Corrects the number of LSTM cells, where lstm_2 is always less than or equal to lstm_1.
        decoded_params_bkp = copy.deepcopy(decoded_params)
        for decoded_param in decoded_params:
            if 'lstm_1' in decoded_param and 'lstm_2' in decoded_param:
        ...
        decoded_params = copy.deepcopy(decoded_params_bkp)
